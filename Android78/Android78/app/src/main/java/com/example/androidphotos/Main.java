...
//            }
//
//            albums = findViewById(R.id.thumbnailList);
//
//            layoutView = getLayoutInflater().inflate(R.layout.album_list_view, null);
//
...
//        try {
//            Intent gotoAlbumViewIntent = new Intent(this, AlbumController.class);
//
//            final int result = 1;
//
...
//        Intent i = new Intent(this, SearchController.class);
//        startActivity(i);
//    }
//
//
...
public class Main extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        try {
            ...
            userData.setDataPath(packageInfo.applicationInfo.dataDir);
        }catch (PackageManager.NameNotFoundException e){
            showToast("Error.");
        }
    ...
    public void confirmAlbumDeletion(){
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        userData.getUser().getAlbums().remove(selectedAlbumIndex);
                        refreshList();
                    }})
                .setNegativeButton(android.R.string.no, null).show();
    }
    ...
    public void showAlbumOptions(){
        ...
        b.setItems(types, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                switch(which){
                    case 0:
                        userData.setActiveAlbum(userData.getUser().getAlbums().get(selectedAlbumIndex));
                        gotoAlbumView(selectedAlbumIndex);
                        break;
                    case 1:
                        AlertDialog.Builder builder = new AlertDialog.Builder(Main.this);
                        builder.setTitle("Enter the new value for the tag");
                        ...
                        final EditText input = new EditText(Main.this);
                        input.setText(userData.getUser().getAlbums().get(selectedAlbumIndex).getName());
                        input.setInputType(InputType.TYPE_CLASS_TEXT);
                        builder.setView(input);
                        ...
                        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if(albumNameExists(input.getText().toString())){
                                    ...
                                    Album a = userData.getUser().getAlbums().get(selectedAlbumIndex);
                                    a.setName(input.getText().toString());
                                    refreshList();
                                }
                            }
    ...
    public void addAlbum(View view){
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                userData.getUser().getAlbums().add(new Album(albumName));
                refreshList();
            }
        });
        builder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
